<template>
    <div class="abnormal-container w-full h-full p-2">
        <div class="flex justify-between items-center mb-2">
            <div class="text-lg font-bold text-white text-center" style="letter-spacing: 2px;">
                工单异常
            </div>
            <el-button 
              type="primary" 
