<template>
  <div class="line1-container flex flex-col ">
    <div class="grid grid-cols-3 gap-4">
      ...
      <dv-border-box-12 class="data-box ">
      <Datacard title="今日已生产" EnlishTitle="ProducedToday" :value="productionData.done" />
      </dv-border-box-12>

      <dv-border-box-12 class="data-box ">
      <Datacard title="今日待生产" EnlishTitle="To Be Produced Today" :value="productionData.undone" />
      </dv-border-box-12>
    </div>
